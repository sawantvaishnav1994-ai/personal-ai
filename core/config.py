...
class Settings:
    ...
    model_retry_attempts:int=max(0,min(3,int(os.getenv('MODEL_RETRY_ATTEMPTS','1'))))
    model_retry_backoff_seconds:float=max(0.0,min(2.0,float(os.getenv('MODEL_RETRY_BACKOFF_SECONDS','0.05'))))
    model_max_failovers:int=max(0,min(5,int(os.getenv('MODEL_MAX_FAILOVERS','3'))))
