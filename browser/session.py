...
class PersistentBrowser:
    ...
    def snapshot(self):
        self.start(); data=observe_page(self.page); return {'url':data['url'],'title':data['title'],'text':data['visible_text'],'domain':data['domain'],'tab_index':data['tab_index'],'tab_count':data['tab_count']}
    def observe(self):
